...
static u_char ngx_rtmp_mpegts_header[] = {
    ...
    /* PSI */
    0x02, 0xb0, 0x3a, 0x00, 0x01, 0xc1, 0x00, 0x00,
    /* PMT */
    0xe1, 0x00,
    0xf0, 0x00,
    0xff, 0xff, 0x49, 0x44, 0x33, 0x20, 0xff, 0x49, 0x44, 0x33, 0x20, 0x00, 0x1f, 0x00, 0x01, /* metadata_pointer_descriptor */
    0x1b, 0xe1, 0x00, 0xf0, 0x00, /* h264 */
    0x15, 0xe1, 0x02, 0xf0, 0x0f, /* id3 */
    0x26, 0x0d, 0xff, 0xff, 0x49, 0x44, 0x33, 0x20, 0xff, 0x49, 0x44, 0x33, 0x20, 0x00, 0x0f, /* metadata_descriptor */
    ...
    /* TS */
    0x47, 0x41, 0x02, 0x10,  0x00,
    /* PSI */
    0x00, 0x01, 0xbd, 0x00, 0xb2, 0x84, 0x80,
    0x00, /* PES header length placeholder (188 - tag length - 13) */
...
static ngx_int_t
ngx_rtmp_mpegts_write_header(ngx_rtmp_mpegts_file_t *file, ngx_uint_t *audio_codec_id, uint64_t datetime_timestamp)
{
...
ngx_rtmp_mpegts_open_file(ngx_rtmp_mpegts_file_t *file, u_char *path,
    ngx_log_t *log, ngx_uint_t *audio_codec_id, uint64_t datetime_timestamp)
{
    file->log = log;
    ...
    if (ngx_rtmp_mpegts_write_header(file, audio_codec_id, datetime_timestamp) != NGX_OK) {
        ngx_log_error(NGX_LOG_ERR, log, ngx_errno,
